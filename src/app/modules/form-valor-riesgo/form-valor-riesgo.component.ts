...
export class FormValorRiesgoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log("USER MOD", this.userMod);
  ...
  async onSubmit(){
    ...
    if(this.vrform.valid){
      ...
      if(this.localVR !== null){
        ...
        await this.valoraRiesgoService.createvalorRiesgo(this.vrform.value).toPromise().then((data:any)=>{
          if(data){
  ...
  async buscarArea(){
    ...
    if (this.localVR !== null) {
      ...
      id = this.vrform.value.idpempresa;
    }
    this.area =[];
