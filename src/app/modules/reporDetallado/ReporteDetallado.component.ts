  ...
  reporteDetalladoEmpleado() {
      ...
      dataReporte = rDETemp.map( item => { 
        ...
        return {
          ...
          'CARGO':item.emdcargo,
          'PROFESIÓN':item.emdprofesion,
          'TELÉFONO':item.emdtelefono,
          ...
          'RETROALIMENTACIÓN': item.Resintr_lider_retroalimenta,
          ...
          'RETROALIMENTACIÓN VALOR': item.intr_lider_retroalimenta_val,
          ...
          'PARTICIPACIÓN': item.Resintr_ctrl_cambio,
          'AUTONOMÍA': item.Resintr_ctrl_autonomia,
          ...
          'PARTICIPACIÓN VALOR':item.intr_ctrl_cambio_val,
          'AUTONOMÍA VALOR':item.intr_ctrl_autonomia_val,
          ...
          'RELACIÓN FAMILIA':  item.Resextralab_relafami,
          'COMUNICACIÓN':  item.Resextralab_comunicacion,
          'SITUACIÓN ECONÓMICA': item.Resextralab_situacion_econo,
          ...
          'RELACIÓN FAMILIA VALOR':item.extralab_relafami_val,
          'COMUNICACIÓN VALOR':item.extralab_comunicacion_val,
          'SITUACIÓN ECONÓMICA VALOR':item.extralab_situacion_econo_val,
          ...
          'ESTRÉS VALOR':item.estres_total_val,
