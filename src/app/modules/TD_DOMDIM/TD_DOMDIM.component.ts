...
total_general2 :any[] = [];
  ...
  async metodo(id:number){
    ...
    this.Riesgo_muy_altoD = Number((((this.donadata[4] *100)/this.total)));
      ...
      this.dataDona = [
        { category: 'Riesgo_bajo', value: (new Intl.NumberFormat().format(this.Riesgo_bajoD )), colorField: '#97C015' },
        { category: 'Riesgo_medio', value: (new Intl.NumberFormat().format(this.Riesgo_medioD )), colorField: '#F0F012'},
        { category: 'Riesgo_alto', value: (new Intl.NumberFormat().format(this.Riesgo_altoD )), colorField: '#F07712' },
        { category: 'Riesgo_muy_alto', value: (new Intl.NumberFormat().format(this.Riesgo_muy_altoD )), colorField:'#FC0202' },
